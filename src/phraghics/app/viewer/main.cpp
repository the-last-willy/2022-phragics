...
#include "phragics/common/file.hpp"
#include "phragics/dep/glfw/all.hpp"
#include "phragics/dep/imgui/all.hpp"
#include "phragics/common/modeling.hpp"
#include "phragics/core/shading.hpp"
...
auto linked_program(gpu::Context& gpu, const ProgramDescription& desc) -> gpu::ProgramHandle {
    ...
    if(std::filesystem::exists(desc.fragment_shader_path)) {
        ...
        auto content = phragics::content(desc.fragment_shader_path);
    ...
    if(std::filesystem::exists(desc.vertex_shader_path)) {
        ...
        auto content = phragics::content(desc.vertex_shader_path);
        auto len = GLint(size(content));
        auto str = data(content);
...
//    pdesc.fragment_shader_path = "D:/dev/project/phragics/src/phragics/core/shading/basic.frag";
//    pdesc.vertex_shader_path = "D:/dev/project/phragics/src/phragics/core/shading/basic.vert";
//    program = linked_program(pdesc);
    ...
    { // Billboard.
        ...
        pd.fragment_shader_path = "D:\\dev\\project\\phragics\\src\\phragics/core\\shading\\billboard.frag";
        pd.vertex_shader_path = "D:\\dev\\project\\phragics\\src\\phragics/core\\shading\\billboard.vert";
...
//    }
    ...
    if(glfwGetKey(a.window, GLFW_KEY_E) == GLFW_PRESS) {
        ...
        auto success = stbi_write_png("D:\\dev\\project\\phragics\\tmp\\screenshot.png", 1600, 900, 3, data(pixels), 0);
        if(!success) {
